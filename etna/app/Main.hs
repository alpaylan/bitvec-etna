...
witnessesFor "ReadBitRoundTrip" =
  [ ("witness_read_bit_round_trip_case_true",  W.witness_read_bit_round_trip_case_true)
  , ("witness_read_bit_round_trip_case_false", W.witness_read_bit_round_trip_case_false)
  ]
witnessesFor "F2PolySignumOne" =
  [ ("witness_f2_poly_signum_one_case_three",     W.witness_f2_poly_signum_one_case_three)
  , ("witness_f2_poly_signum_one_case_fortytwo",  W.witness_f2_poly_signum_one_case_fortytwo)
  ]
witnessesFor "BitIndexWordOffset" =
  [ ("witness_bit_index_word_offset_case_pos100_len200", W.witness_bit_index_word_offset_case_pos100_len200)
  , ("witness_bit_index_word_offset_case_pos130_len150", W.witness_bit_index_word_offset_case_pos130_len150)
  ]
witnessesFor _ = []
...
runQuickCheck "ReadBitRoundTrip" =
  qcDrive (QC.forAll GQ.gen_read_bit_round_trip (qcProp P.property_read_bit_round_trip))
runQuickCheck "F2PolySignumOne" =
  qcDrive (QC.forAll GQ.gen_f2_poly_signum_one (qcProp P.property_f2_poly_signum_one))
runQuickCheck "BitIndexWordOffset" =
  qcDrive (QC.forAll GQ.gen_bit_index_word_offset (qcProp P.property_bit_index_word_offset))
...
runHedgehog "ReadBitRoundTrip" =
  hhDrive GH.gen_read_bit_round_trip P.property_read_bit_round_trip
runHedgehog "F2PolySignumOne" =
  hhDrive GH.gen_f2_poly_signum_one P.property_f2_poly_signum_one
runHedgehog "BitIndexWordOffset" =
  hhDrive GH.gen_bit_index_word_offset P.property_bit_index_word_offset
...
runFalsify "ReadBitRoundTrip" =
  fsDrive GF.gen_read_bit_round_trip P.property_read_bit_round_trip
runFalsify "F2PolySignumOne" =
  fsDrive GF.gen_f2_poly_signum_one P.property_f2_poly_signum_one
runFalsify "BitIndexWordOffset" =
  fsDrive GF.gen_bit_index_word_offset P.property_bit_index_word_offset
...
runSmallCheck "ReadBitRoundTrip" =
  scDrive GS.series_read_bit_round_trip P.property_read_bit_round_trip
runSmallCheck "F2PolySignumOne" =
  scDrive GS.series_f2_poly_signum_one P.property_f2_poly_signum_one
runSmallCheck "BitIndexWordOffset" =
  scDrive GS.series_bit_index_word_offset P.property_bit_index_word_offset
